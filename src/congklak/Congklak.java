...
public class Congklak extends javax.swing.JFrame {
    ...
    private boolean statusHome1, statusHome2, statusHome3, statusHome4, statusHome5,
            ...
            statusScoreHome, statusScoreAway, isServerHome, isServerAway;
    ...
    private int onHand;
    private int scoreHome, scoreAway, statusku;
    ...
    public void kirim(String klue) {
        try{
            Socket cl=new Socket("192.168.137.77", 12345);
